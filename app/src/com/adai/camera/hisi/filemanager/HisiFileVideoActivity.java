 ...
 * @author huangxy
 */
public class HisiFileVideoActivity extends BaseActivity implements HisiFileActivityContract.View {
    private HisiFileFragment mCyclicVideoFragment, mUrgentVideoFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hisi_file_video);
        VLCApplication.getInstance().setAllowDownloads(true);
        init();
        initView();
        if (mCyclicVideoFragment == null) {
            mCyclicVideoFragment = HisiFileFragment.newInstance(2, FileManagerConstant.TYPE_REMOTE_NORMAL_VIDEO);
        }
        mAdapter.addFragment(mCyclicVideoFragment, getString(R.string.cyclic_video));
        if (mUrgentVideoFragment == null) {
            mUrgentVideoFragment = HisiFileFragment.newInstance(2, FileManagerConstant.TYPE_REMOTE_URGENCY_VIDEO);
        }
    ...
    private void initFile() {
        mPresenter.initFile(FileManagerConstant.TYPE_REMOTE_VIDEO);
    }
