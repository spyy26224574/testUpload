...
public class NovatekFilePresenter extends NovatekFileContract.Presenter {
        ...
        CameraUtils.getFileList(new CameraUtils.GetFileListListener() {
            ...
            public void success(List<FileDomain> fileDomains) {
                ...
                for (FileDomain fileDomain : fileDomains) {
                    if (mType == FileManagerConstant.TYPE_REMOTE_PHOTO) {
...
//    }
    ...
    @Override
    public void attachView(NovatekFileContract.View view) {
