...
//		}
    ...
    public View getTitleView(int group, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            ll.setBackgroundColor(parent.getResources().getColor(R.color.page_background));
            convertView = ll;
            SizeHelper.prepare(parent.getContext());

            TextView tv = new TextView(parent.getContext());
            tv.setTextSize(TypedValue.COMPLEX_UNIT_PX, SizeHelper.fromPxWidth(16));
            tv.setTextColor(parent.getContext().getResources().getColor(R.color.lv_title_color));
...
//            ll.setBackgroundColor(0xffffffff);
            ...
            TextView tv = new TextView(parent.getContext());
            tv.setTextColor(parent.getContext().getResources().getColor(R.color.lv_tv_color));
