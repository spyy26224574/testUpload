...
public class VLCOptions {
    ...
    public static ArrayList<String> getLibOptions() {
        ...
        int networkCaching = VLCOptions.getCaching();
...
//        if (networkCaching > 0)
        ...
        options.add(":sout-mux-caching="+2500);//输出缓存 
    ...
    public static int getCaching() {
        final SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(VLCApplication.getAppContext());
        return pref.getInt("network_caching_value", 500);
    }

    public static void setCaching(int cacheValue) {
        final SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(VLCApplication.getAppContext());
        pref.edit().putInt("network_caching_value", cacheValue).apply();
    }
